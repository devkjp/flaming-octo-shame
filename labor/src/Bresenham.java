public class Bresenham {
	...
	public static void drawLine(GraphArea.color[][] canvas, int startX,
			int startY, int endX, int endY, GraphArea.color colorCode) {
		int w = endX - startX;
		int h = endY - startY;
		...
		for (int i = 0; i <= longest; i++) {
			if (0 <= startX && startX < canvas.length && 0 <= startY
	...
	public static void drawNiceCircle(GraphAreaInterface.color[][] canvas,
	...
	public static void drawCircle(GraphAreaInterface.color[][] canvas,
			int midX, int midY, int radius, GraphAreaInterface.color colorCode) {
